...
> Stav k 2026-09-05: tento dokument zachovává návrh budoucího workflow
> agenta a trvalého scheduleru. Dnešní James už nabízí Cowork nad
> `lib/wrapp_agent.py`, profily v `agent/agents.json`, pravidla nástrojů,
> omezený počet kroků a volitelné review. Plány ukládá do projektového
> `.cowork/plans.json`; nejde ještě o níže navržený SQLite DAG scheduler
> s leases a obnovou po pádu. Hardware/Nostr používají lokální nástroje
> sdílené s MCP servery, nikoli obecného MCP klienta nad všemi flows.
