...
> Dokument zachovává výchozí rozbor a následnou Implementaci 01; úvodní
> „Současný stav“ popisuje stav před touto migrací. K 2026-09-05 už fungují
> `--input`, `--context`, `--rules`, `--replace-rules` a `--dry-run`, včetně
> systémových instrukcí pro OCR/describe. Novější rozdělení profiles a
> capabilities popisuje `kontextove_okno_02_cz.md`. Historii Chatu skládá
> James nad CLI; samotný jednorázový CLI request ji stále nepřidává automaticky.
