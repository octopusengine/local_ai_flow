...
```text
--sc-cz | --sc-en    vybere jazyk command pravidel a jazyk odpovědi
...
```text
český vstup -> task_translate --c2a -> --sc-en pracovní task -> anglický výstup
anglický vstup -> task_translate --e2c -> --sc-cz pracovní task -> český výstup
```
