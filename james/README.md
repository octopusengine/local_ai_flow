...
- **MCP nostr** is a reserved module entry marked *preparing*. It becomes usable only after its own `cli_nostr.py`, `requirements_nostr.txt`, and server configuration exist.
