...
# This file is named mcp.py as the project's generic server wrapper. Remove its
# directory temporarily so that this module does not shadow the installed
# `mcp` package while FastMCP is imported.
